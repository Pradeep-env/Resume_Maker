...
const Navbar = () => {
    const userOpt = [
        { name: "Templates", link: "#", icon: <Paperclip size={20} />, num: 1 },
        { name: "Articles", link: "#", icon: <Newspaper size={20} />, num: 2 },
        { name: "Pricing", link: "#", icon: <Tag size={20} />, num: 3 },
        { name: "Login", link: "#", icon: <LogIn size={20} />, num: 4 },
        { name: "Create Resume", link: "#", icon: <Zap size={20} />, num: 5 },
    ]
